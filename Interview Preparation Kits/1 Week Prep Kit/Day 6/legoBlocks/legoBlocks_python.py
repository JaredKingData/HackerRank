def legoBlocks(n, m):
    ...
    # build row combinations up to current wall width
    ...
    # Divide the wall into left part and right part, and calculate the combination of left part and right part.
